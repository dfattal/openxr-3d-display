...
bool GetVulkanInstanceExtensions(XrSessionManager& xr, std::vector<const char*>& extensions) {
    ...
    LOG_INFO("XR_EXT_session_target: %s", hasSessionTarget ? "AVAILABLE" : "NOT FOUND");
    ...
    xr.hasSessionTargetExt = hasSessionTarget;
    ...
    LOG_INFO("Enabling %zu OpenXR extensions", enabledExtensions.size());
    ...
    strcpy_s(createInfo.applicationInfo.applicationName, "SessionTargetTestVulkan");
