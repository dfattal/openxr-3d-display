...
/*!
 * @file
 * @brief  Embedded 8x16 bitmap font for the runtime HUD overlay.
 *
 * Standard IBM VGA 8x16 font (CP437), public domain.
 * Each character is 16 bytes (16 rows, 8 pixels per row, MSB = leftmost).
 * Covers ASCII 0x00-0x7F (control chars 0x00-0x1F are blank).
 *
 * @author David Fattal
 * @ingroup aux_util
 */
...
/*!
 * 8x16 bitmap font data. Index as u_hud_font_data[char_code][row].
 * Each byte is 8 horizontal pixels, MSB = leftmost pixel.
 */
static const unsigned char u_hud_font_data[128][16] = {
	/* 0x00 NUL */ {0},
	/* 0x01 SOH */ {0},
	/* 0x02 STX */ {0},
	/* 0x03 ETX */ {0},
