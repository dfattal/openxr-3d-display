...
| **Monado Runtime** | Pre-built from CNSDK-OpenXR CI — see [Deploying to End Users](#deploying-to-end-users) |
...
1. Clone or download the `com.monado.display3d` folder to your machine
2. In Unity: **Window > Package Manager**
3. Click **+** (top-left) > **Add package from disk...**
4. Navigate to `com.monado.display3d/package.json` and select it

### Option B: From Git URL

1. In Unity: **Window > Package Manager**
2. Click **+** > **Add package from git URL...**
3. Enter:
   ```
   https://github.com/LeiaInc/CNSDK-OpenXR.git?path=com.monado.display3d
   ```
...
1. **Monado Runtime** — Install via the `SRMonadoInstaller.exe` from the CNSDK-OpenXR CI build artifact (registers the runtime JSON and copies DLLs system-wide)
